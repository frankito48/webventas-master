...
export const getProductos = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://amoremiobkend.vercel.app/producto/producto`);
...
export const getAllClientes = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://amoremiobkend.vercel.app/cliente/allClientes`)
...
export const getPedidos = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://amoremiobkend.vercel.app/pedido/Lpedidos`)
      dispatch({
        type: GET_PEDIDOS,
        payload: response.data,
      });
...
export const addProduct = (formData) => {
  ...
  return async function (dispatch) {
    try {
      ...
      const response = await axios.post(`https://amoremiobkend.vercel.app/producto/nuevoProducto`, formData);
...
export const getById = (id) => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://amoremiobkend.vercel.app/producto/ProductoId/${id}`);
...
export const createUsuario = (userData) => {
  ...
  return async function (dispatch) {
    try {
      const response = await axios.post(`https://amoremiobkend.vercel.app/cliente/nuevoCliente`, userData);
      dispatch({
...
export const ingresarUsuario = (userData) => {
  return async function (dispatch) {
    try {
      ...
      const response = await axios.post(`https://amoremiobkend.vercel.app/cliente/login`, userData);
...
export const obtenerInformacionUsuario = (correo, contraseña) => {
  return async function (dispatch) {
    try {
      const response = await axios.post(`https://amoremiobkend.vercel.app/cliente/InfoUsuario`, { correo, contraseña });
...
export const obtenerClientePorId = (id) => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://amoremiobkend.vercel.app/cliente/cliente/${id}`);
...
export const cambios = (id, datosProducto) => {
  return async function (dispatch) {
    try {
      const response = await axios.patch(`https://amoremiobkend.vercel.app/Nadmin/cambioAdmin/${id}`, datosProducto);
      dispatch({
        type: CAMBIO,
        payload: response.data,
      });
...
export const borrar = async (id) => {
  try {
    ...
    const borrar = await axios.delete(`https://amoremiobkend.vercel.app/producto/eliminar/${id}`)
...
export const addPedido = (productos) => {
  ...
  return async function () {
    try {
      const response = await axios.post('https://amoremiobkend.vercel.app/pedido/nuevoPedido', {
        productos: productos,
      });
...
export const actualizarVariante = (id, cantidad_disponible) => { // Asegúrate de pasar cantidad_disponible aquí
  return async function (dispatch) {
    try {
      ...
      const response = await axios.patch(`https://amoremiobkend.vercel.app/producto/cambio/${id}`, {
...
export const buscar = (name) => {
  return async function (dispatch) {
    try {
      ...
      const response = await axios.get(`https://amoremiobkend.vercel.app/producto/name/${name}`);
...
export const enviarCorreo = (idPedido, infoPedido, correo) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://amoremiobkend.vercel.app/Nadmin/confirmacionPedido', {
        idPedido: idPedido,
...
export const LoginAdmin = (password) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://amoremiobkend.vercel.app/Nadmin/loginc', {
        password: password,
      });
...
export const ofertas = (oferta) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://amoremiobkend.vercel.app/oferta/nuevaOferta', {
        oferta: oferta
      });
...
export const getOfertas = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get('https://amoremiobkend.vercel.app/oferta/ofertas');
...
export const borrarOferta = async (id) => {
  try {
    ...
    const borrar = await axios.delete(`https://amoremiobkend.vercel.app/oferta/eliminar/${id}`)
