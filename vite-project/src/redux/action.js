...
export const getProductos = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://backend-webventas.onrender.com/producto/producto`);
...
export const getAllClientes = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://backend-webventas.onrender.com/cliente/allClientes`)
...
export const getPedidos = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://backend-webventas.onrender.com/pedido/Lpedidos`)
      dispatch({
        type: GET_PEDIDOS,
        payload: response.data,
      });
...
export const addProduct = (formData) => {
  ...
  return async function (dispatch) {
    try {
      ...
      const response = await axios.post(`https://backend-webventas.onrender.com/producto/nuevoProducto`, formData);
...
export const getById = (id) => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://backend-webventas.onrender.com/producto/ProductoId/${id}`);
...
export const createUsuario = (userData) => {
  ...
  return async function (dispatch) {
    try {
      const response = await axios.post(`https://backend-webventas.onrender.com/cliente/nuevoCliente`, userData);
      dispatch({
...
export const ingresarUsuario = (userData) => {
  return async function (dispatch) {
    try {
      ...
      const response = await axios.post(`https://backend-webventas.onrender.com/cliente/login`, userData);
...
export const obtenerInformacionUsuario = (correo, contraseña) => {
  return async function (dispatch) {
    try {
      const response = await axios.post(`https://backend-webventas.onrender.com/cliente/InfoUsuario`, { correo, contraseña });
...
export const obtenerClientePorId = (id) => {
  return async function (dispatch) {
    try {
      const response = await axios.get(`https://backend-webventas.onrender.com/cliente/cliente/${id}`);
...
export const cambios = (id, datosProducto) => {
  return async function (dispatch) {
    try {
      const response = await axios.patch(`https://backend-webventas.onrender.com/Nadmin/cambioAdmin/${id}`, datosProducto);
      dispatch({
        type: CAMBIO,
        payload: response.data,
      });
...
export const addPedido = (productos) => {
  ...
  return async function () {
    try {
      const response = await axios.post('https://backend-webventas.onrender.com/pedido/nuevoPedido', {
        productos: productos,
      });
...
export const actualizarVariante = (id, cantidad_disponible) => { // Asegúrate de pasar cantidad_disponible aquí
  return async function (dispatch) {
    try {
      ...
      const response = await axios.patch(`https://backend-webventas.onrender.com/producto/cambio/${id}`, {
...
export const buscar = (name) => {
  return async function (dispatch) {
    try {
      ...
      const response = await axios.get(`https://backend-webventas.onrender.com/producto/name/${name}`);
...
export const enviarCorreo = (idPedido, infoPedido, correo) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://backend-webventas.onrender.com/Nadmin/confirmacionPedido', {
        idPedido: idPedido,
...
export const LoginAdmin = (password) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://backend-webventas.onrender.com/Nadmin/loginc', {
        password: password,
      });
...
export const ofertas = (oferta) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://backend-webventas.onrender.com/oferta/nuevaOferta', {
        oferta: oferta
      });
...
export const getOfertas = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get('https://backend-webventas.onrender.com/oferta/ofertas');
...
export const borrarOferta = async (id) => {
  try {
    ...
    const borrar = await axios.delete(`https://backend-webventas.onrender.com/oferta/eliminar/${id}`)
